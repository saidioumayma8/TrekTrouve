...
<head>
	...
	<!-- Import Icon -->
  	<link rel="stylesheet" type="text/css" href="resources/css/css/ionicons.min.css">

	<!-- Import Style -->
	<link rel="stylesheet" type="text/css" href="resources/css/css/main.css">
...
<script type="text/javascript" src="resources/js/js/main.js"></script>
<script type="text/javascript" src="resources/js/js/swipe.js"></script>
</body>
</html>
